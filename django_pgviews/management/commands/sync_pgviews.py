...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help='Nominates a specific database to create/update views in. Defaults to the "default" database.',
        )

    def handle(self, force, update, using, **options):
        vs = ViewSyncer()
        vs.run(force, update, using)
